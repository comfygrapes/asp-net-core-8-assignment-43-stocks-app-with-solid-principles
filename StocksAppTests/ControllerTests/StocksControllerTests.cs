...
namespace StocksAppTests.ControllerTests
{
    public class StocksControllerTests
    {
        ...
        public async Task Explore_StockIsNull_ShouldReturnExploreViewWithStocks()
        {
            ...
            var stocksController = new StocksController(_finnhubStocksService, _tradingOptions, loggerMock.Object);
            ...
            _finnhubStocksServiceMock.Setup(temp => temp.GetStocks()).ReturnsAsync(stocks);
